...
- **Application**: Seed, the software program provided by the Company.
...
- Email hey@Seed.app with the subject line: "delete account". In the body of your email, make sure to send us the email you signed up with.
- Logout of the app
